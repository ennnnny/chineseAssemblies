...
namespace Tracker
{
    ...
    public static class HbTracker
    {
        ...
        {
            Config = menu.AddSubMenu(new Menu("妫€娴婥D ", "CD Tracker"));
            Config.AddItem(new MenuItem("TrackAllies", "鏄剧ず鐩熷弸 ").SetValue(true));
            Config.AddItem(new MenuItem("TrackEnemies", "鏄剧ず鏁屼汉 ").SetValue(true));
        }
