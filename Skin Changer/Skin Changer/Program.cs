...
namespace Skin_Changer
{
    class Program
    {
        ...
        public static void Game_OnGameLoad(EventArgs args)
        {
            ...
            Config = new Menu("鏀瑰彉鐨偆", "SkinChanger", true);
            var ChangeSkin = Config.AddItem(new MenuItem("CycleSkins", "鏀瑰彉鐨偆").SetValue(new KeyBind("9".ToCharArray()[0], KeyBindType.Toggle)));
